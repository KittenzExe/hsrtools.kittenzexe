...
<div id="content-holder">
    <div id="content-topbar">
        ...
        <div id="content-topbar-info">The place for information and guides!</div>
    </div>
    <div id="content-grid-container">
        <div id="content-grid-item">
            <div id="content-grid-item-decor">Genshin to <br> Star Rail <br> Guide</div>
            <a href="../database/genshin-to-star-rail"><img src="/images/other/braindamage.jpg" id="content-grid-item-character" alt="braindamage" style="margin-left: -120px; margin-top: -10px; height: 200px; width: flex;"></a><!-- update before out of beta -->
        </div>
    </div>
</div>
