...
<div id="content-holder">
    <div id="content-image-wrap">
        <img src="/images/character-art/Clara/Character_Clara_Portrait.webp" alt="clara" style="height: 650px;">
    </div>
    <div id="content-topbar">
      <div id="content-topbar-title">Clara <img src="/images/icon/Icon_5_Stars.webp" alt="5 star" height="35px"> <img src="/images/elements/Element_Physical.webp" alt="physical" height="35px"> <img src="/images/path/Path_The_Destruction.webp" alt="destruciton" height="35px"></div>
      <div id="content-topbar-info" style="font-size: 20px;">"Mr. Svarog... is my family."</div>
    </div>
