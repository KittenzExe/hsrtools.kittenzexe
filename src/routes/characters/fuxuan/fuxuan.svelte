...
<div id="content-holder">
    <div id="content-image-wrap">
        <img src="/images/character-art/FuXuan/Character_Fu_Xuan_Splash_Art.webp" alt="dan heng 2.0" style="height: 500px;">
    </div>
    <div id="content-topbar">
      <div id="content-topbar-title">Fu Xuan<img src="/images/icon/Icon_5_Stars.webp" alt="5 star" height="35px"> <img src="/images/elements/Element_Quantum.webp" alt="quantum" height="35px"> <img src="/images/path/Path_The_Preservation.webp" alt="preservation" height="35px"></div>
      <div id="content-topbar-info" style="font-size: 20px;">"Not Released yet..."</div>
    </div>
